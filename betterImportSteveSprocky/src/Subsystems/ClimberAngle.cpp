...
int ClimberAngle::GetAngle(){
	double string = analogPotentiometer1->Get();// gets the length in inches
	//Finds angle of Potentiometer using Pythag Thm and Trig
	double angle = acos((( this->arm * arm + constant * constant - string * string)/(2 * arm * constant)) * (180.0 / PI));
